...
class FrmPersegi:
    ...
    def aturKomponen(self):
        ...
        Label(mainFrame, text="Luas bela ketupat adalah:", border=0, width=30, font=30, background="#C9EEFF").grid(row=6, column=0, sticky=W, padx=20, pady=5)
...
if __name__ == '__main__':  
    root = Tk() 
    aplikasi = FrmPersegi(root, "Program Luas Bela ketupat = By reza ramadhan")
    root.mainloop()
